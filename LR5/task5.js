var showPhotoPost = function (photoPost) {
    let buffer = "";
    ...
    return function () {
        ...
        this.getPhotoPosts = function (skip, top, filterConfig) {
            ...
            for (let i = 0; i < newPosts.length; i++) {
                if (currentUser === newPosts[i].author) {
                    ...
                    document.getElementById("feedback").innerHTML += showPhotoPost(newPosts[i]);
                }
            }
        }
        ...
        this.addPhotoPost = function (photoPost) {
            ...
            if (this.validatePhotoPost(photoPost) && this.getPhotoPost(photoPost.id) === null) {
                ...
                document.getElementById("feedback").innerHTML += showPhotoPost(photoPost);
                return true;
            }
        ...
        this.removePhotoPost = function (id) {
            ...
            for (var i = 0; i < this.photoPosts.length; i++) {
                if (this.photoPosts[i].id === id) {
                    ...
                    arrElem = document.getElementById('feedback').getElementsByClassName('post');
                    arrElem[i].remove();
                    return true;
                }
            }
